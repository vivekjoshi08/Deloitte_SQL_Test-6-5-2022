...
/*select Act_Name from actor a inner join movie_cast c1 on c1.Actor_id = a.Actor_id
inner join movie_cast c2 on c2.Act_id = a.Act_id
inner join movie m1 on c1.Act_id = m1.Act_id
inner join movie m2 on c2.Act_id = m2.Act_id where m1.Mov_Year >2015 and m2.Mov_Year <2000;*/
